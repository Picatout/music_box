...
#define TABAC_TEMPO (20)
#define TABAC_SCORE (30)
#define TABAC_LEN (TABAC_SCORE*2+2)

unsigned char code bon_tabac[TABAC_LEN]={
		TABAC_LEN,TABAC_TEMPO,
		G4,QUARTER,
		A4,QUARTER,
		B4,QUARTER,
		G4,QUARTER,
...
#define SOURIS_TEMPO (20)
#define SOURIS_SCORE (52)
#define SOURIS_LEN (SOURIS_SCORE*2+2)
char code souris_verte[SOURIS_LEN]={
		SOURIS_LEN,SOURIS_TEMPO,
		G4,HEIGHTH,
		G4,HEIGHTH,
		G4,HEIGHTH,
		A4,HEIGHTH,
...
#define GOD_SAVE_TEMPO (20)
#define GOD_SAVE_SCORE (41)
#define GOD_SAVE_LEN (GOD_SAVE_SCORE*2+2)
char code god_save[GOD_SAVE_LEN]={
		GOD_SAVE_LEN,GOD_SAVE_TEMPO,
		C5,QUARTER,
		C5,QUARTER,
		D5,QUARTER,
		B4,QUARTER+HEIGHTH,
...
#define BEAU_SAPIN_TEMPO (18)
#define BEAU_SAPIN_SCORE (50)
#define BEAU_SAPIN_LEN (BEAU_SAPIN_SCORE*2+2)
char code beau_sapin[BEAU_SAPIN_LEN]={
		BEAU_SAPIN_LEN,BEAU_SAPIN_TEMPO,
		PAUSE,QUARTER,
		PAUSE,QUARTER,
		D4,QUARTER,
		G4,HEIGHTH+SIXTEENTH,
		G4,SIXTEENTH,
		G4,QUARTER,
		A4,QUARTER,
		B4,HEIGHTH+SIXTEENTH,
		B4,SIXTEENTH,
		B4,QUARTER+HEIGHTH,
		B4,HEIGHTH,
		A4,HEIGHTH,
